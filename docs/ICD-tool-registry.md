...
- Design contracts: [`docs/ROLES_AND_TOOLS.md`](ROLES_AND_TOOLS.md) — admission narrative + per-tool role table; [`docs/DESIGN-profiles.md`](DESIGN-profiles.md) — profile contract + Two-View Configuration; [`docs/PLUGIN.md`](PLUGIN.md) — plugin-side tool-registration shape.
