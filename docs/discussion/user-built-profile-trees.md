...
**Touches:** [`js/profiles/registry.js`](../../js/profiles/registry.js), [`js/settings/roles-tab.js`](../../js/settings/roles-tab.js) (UI), [`js/core.js`](../../js/core.js) (`State.settings`), [`docs/DESIGN-profiles.md`](../DESIGN-profiles.md).
...
- [x] Phase 4 placeholder issue filed: gitea#443 — tracking only, non-blocking, no schedule.
- [ ] [`docs/DESIGN-profiles.md`](../DESIGN-profiles.md) gains a §User-Authored Profiles section — ships with the Phase 4 authoring API, not this paper.
