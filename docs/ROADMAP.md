...
> Last updated: 2026-05-07 · Current released (tagged) version: **1.6.5** · `main` HEAD: **1.8.3** (1.8.2 patched the duplicate-streak refusal envelope with a tool-aware `next_action_hint`; 1.8.3 fixed an `EditTracker.checkStale` overlap blind-spot that produced silent-deletion under sequential edits to shared HTML files, and restored the Debug slide-out's missing Clear button — both surfaced by the 2026-05-07 HTML-Games dogfood + breakout #124 verify; `1.6.6`–`1.6.14`, `1.7.0`–`1.7.2`, `1.8.0`–`1.8.3` sit untagged in main awaiting the next tag-push gate).
...
| **Later** | Open issues #25, #33, #27, #18 (see *Known open issues* below) — none currently on the active track. |
