...
| **Now** | **Slot reopened.** Plan Mode (1.10.0), ChatHistoryStore + per-conversation scratchpad (1.11.0), Plan Mode session-locality reframe (1.11.1), and the **branch-switcher upgrade** (1.12.0 — Touch 3 extraction A: row-list with ↑/↓ counts + inline switch/delete/cut-release) all sit in main untagged. 2.0 Profiles is queued; remaining open issues (#37 Phase 2, #27, #24, #18) are slotted below. |
