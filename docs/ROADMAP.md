...
| **Now** | **Slot reopened.** github#25 (Plan Mode) shipped at 1.10.0; the structural ChatHistoryStore + scratchpad-pin work shipped at 1.11.0. 2.0 Profiles is queued; the remaining open issues (#37 Phase 2, #27, #24, #18) are slotted below. |
